...
const Navbar = () => {
  ...
  return (
    ...
    <ul className='hidden md:flex items-start gap-5 font-medium'>
        ...
        {/* <NavLink to={frontend} >
        <li className='py-1 border border-gray-500 hover:bg-black hover:text-white rounded-full'> ADMIN/DOCTOR </li>
        <hr  className='border-none outline-none h-0.5 bg-primary hover:text-white w-3/5 m-auto hidden'/>
        </NavLink> */}
    </ul>
    <div className='flex items-centre gap-4'>
        {
            ...
            ?<div className='flex items-centre gap-2 cursor-pointer group relative'>
                 <img className='w-7 rounded-full' src={userData.image} alt="" />
...
<div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
    ...
    <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium onClick={}'>
